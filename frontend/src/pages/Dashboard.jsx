...
const clusterInfo = {
  ...
  'Extracurricular Focused' : { color:'text-risk-medium', desc:'Active beyond academics — monitor for burnout.' },
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <h1 className="font-display font-bold text-3xl text-paper">Hey, {user?.name?.split(' ')[0]} 👋</h1>
          <p className="text-paper/40 font-body text-sm mt-1">{data.total_logs} log{data.total_logs !== 1?'s':''} recorded</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
        <div className="card flex flex-col items-center justify-center lg:col-span-1 animate-fade-up"
      ...
      {/* Consistency + Cluster */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <ConsistencyCard score={data.consistency_score} logs={data.logs} />
